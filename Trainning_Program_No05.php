...
<html lang="en">
    <head>
      <title>Training Program No05</title>
      <meta charset="utf-8">
    ...
    <div class="container">
            ...
            <h2 onclick="window.location.href='http://localhost:8080/Task-StaffMater/Trainning_Program_No05.php'">DANH SÁCH</h2>
            ...
            <select id="filter" class="loadData" >
                ...
                <table class="table table-bordered showData" id="tbl">
                    ...
                    <?php
                    $sql = "SELECT m_department.`DEPARTMENT_CODE`, m_department.`DEPARTMENT_NAME`, m_user.CODE, m_user.NAME FROM m_department, m_user WHERE  m_department.DEPARTMENT_CODE=m_user.DEPARTMENT_CODE AND m_user.USEFLAG=1;";
