      ...
      <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
        ...
        <script type="text/javascript">
            ...
            $('#tbl tr').click(function(e) {
                ...
                var zipStf = $(this).closest('.tr-hover').find('td:nth-child(6)').text();
                var address1Stf = $(this).closest('.tr-hover').find('td:nth-child(7)').text();
                var address2Stf = $(this).closest('.tr-hover').find('td:nth-child(8)').text();
                var noteStf = $(this).closest('.tr-hover').find('td:nth-child(9)').text();
                var useflagStf = $(this).closest('.tr-hover').find('td:nth-child(10)').text();
    ...
    <body>  
        ...
        if (!empty($_POST["btn_Delete"])) {
            ...
            if(mysqli_query($conn, $sql2)){
                header("location: Trainning_Program_No01.php");
                ob_end_flush();
            }else{
                    ...
                    <table class="table table-bordered">
                                <?php
                                    ...
                                    if(isset($_POST['btn_Update'])){
                                        ...
                                        `TEL1` = '$stf_tel1', `TEL2` = '$stf_tel2', `ZIPNO` = '$stf_zipNo', `ADDRESS1` = '$stf_address1',
                                        `ADDRESS2` = '$stf_address2', `NOTE` = '$stf_note', `USEFLAG` = '1' where `CODE` = " .$_POST['code'] ;
                                ...
                                <tr><td>ZIP No:</td>
                                    <td><input type="tel" required  pattern="[a-zA-Z0-9].{0,10}" value="<?php echo $row1["ZIPNO"]?>" id="zip"></td>
                                </tr>
                                <tr><td>Address 1:</td>
                                ...
                                <tr id="hideRow"><td>USEFLAG:</td>
                                    <td ><input type="text" name="useflag" maxlength="6" value="<?php echo $row1["USEFLAG"];?>" id="useflag"></td>
                                </tr>
                    ...
                    <div class="modal-body">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if(mysqli_num_rows($res)>0){
                                ...
                                $sql1 = " INSERT INTO `db01`.`m_user` (`CODE`, `NAME`, `BIRTHDAY`, `TEL1`, `TEL2` , `ZIPNO`, `ADDRESS1`, `ADDRESS2`, `NOTE`, `USEFLAG`) VALUES 
                                ('$stf_code', '$stf_name', '$stf_birthday', '$stf_tel1', '$stf_tel2', '$stf_zipNo', '$stf_address1', '$stf_address2', '$stf_note',1)";
